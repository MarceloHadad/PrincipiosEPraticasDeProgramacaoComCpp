...
int main()
{
	try
	{
		...
		double result = 0;
		int resultAsInt = 0; // Modifique o programa do exercício 6 para acusar um erro se o resultado não puder ser representado como um **int**.
		char inputTempUnit = ' ';
		...
		case 'c':
			...
			if (resultAsInt != result) error("Can't show the result as an Integer");
